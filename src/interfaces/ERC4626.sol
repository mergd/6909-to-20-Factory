...
abstract contract ERC4626 is ERC20 {
    ...
    //  * MUST not revert
    //  */
    // function asset() external virtual view returns (IERC20 assetTokenAddress);
     ...
     */
    function deposit(uint256 _assets, address _receiver) external virtual returns (uint256 shares);
     ...
     */
    function withdraw(uint256 _assets, address _receiver, address _owner) external virtual returns (uint256 shares);
     ...
     * Those methods should be performed separately.
     */
    function redeem(uint256 _shares, address _receiver, address _owner) external virtual returns (uint256 assets);
}
